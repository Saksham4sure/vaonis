...
const ProductCard = ({name, desc, src, button1, button2}) => {
  return (
    <div className='relative w-[90vw] h-[55vh] lg:w-[50vw] lg:h-auto font-extralight'>
        <img className='rounded-xl h-full w-full object-cover' src={src} />
        <div className='absolute inset-0 text-white flex flex-col px-4 text-center items-center pt-10'>
